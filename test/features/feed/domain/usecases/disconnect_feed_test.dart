...
void main() {
  ...
  group('DisconnectFeed', () {
    test('delegates to repository.disconnect', () async {
      when(
        () => repository.disconnect('srv-1', 'alerts', owner: ConnectionOwner.screen),
      ...
      verify(() => repository.disconnect('srv-1', 'alerts', owner: ConnectionOwner.screen)).called(1);
    });

    test('propagates Failure from repository', () async {
      when(() => repository.disconnect('srv-1', 'alerts', owner: ConnectionOwner.screen)).thenAnswer(
